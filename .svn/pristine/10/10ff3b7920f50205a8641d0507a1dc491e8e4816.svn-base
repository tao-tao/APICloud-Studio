...
import org.tigris.subversion.job.UpgradeJob;
...
/**
 * This is a base class for the JavaHL Adapter. It allows the JavaHL Adapter and
 * the SVNKit Adapter to share most of their implementation.
 * 
...
public abstract class AbstractJhlClientAdapter extends AbstractClientAdapter {
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#addNotifyListener
	 * (org.tigris.subversion.svnclientadapter.ISVNNotifyListener)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#removeNotifyListener
	 * (org.tigris.subversion.svnclientadapter.ISVNNotifyListener)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.tigris.subversion.svnclientadapter.ISVNClientAdapter#
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#setUsername(
	 * java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#setPassword(
	 * java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#addFile(java
	 * .io.File)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.subclipse.client.ISVNClientAdapter#addDirectory
	 * (java.io.File, boolean)
	 */
	public void addDirectory(File file, boolean recurse)
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#addDirectory
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#checkout(org
	 * .tigris.subversion.svnclientadapter.SVNUrl, java.io.File,
	...
	public void checkout(SVNUrl moduleName, File destPath,
		...
		checkout(moduleName, destPath, revision,
				Depth.infinityOrImmediates(recurse).ordinal(), false, true);
	}
	 ...
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#checkout(org
	 * .tigris.subversion.svnclientadapter.SVNUrl, java.io.File,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, int, boolean,
	 * boolean)
	 */
	public void checkout(SVNUrl moduleName, File destPath,
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#commit(java.
	 * io.File[], java.lang.String, boolean)
	 */
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#commit(java.
	 * io.File[], java.lang.String, boolean, boolean)
	 */
	public long commit(File[] paths, String message, boolean recurse,
		...
		try {
			...
			svnClient.commit(files, Depth.infinityOrEmpty(recurse), keepLocks,
					keepChangeLists, null, null, new JhlCommitMessage(
							fixedMessage), callback);
			 ...
			 * { MessageDialog.openError(null, "commit", "commitexception"); }
			 * });
			 * 
			 * for (int i = 0; i < paths.length; i++) {
			 * upgradeProject(paths[i]); }
			 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getList(org.
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getList(java
	 * .io.File, org.tigris.subversion.svnclientadapter.SVNRevision, boolean)
	 */
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getList(java
	 * .io.File, org.tigris.subversion.svnclientadapter.SVNRevision,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, boolean)
	 */
	public ISVNDirEntry[] getList(File path, SVNRevision revision,
			SVNRevision pegRevision, boolean recurse) throws SVNClientException {
	...
	private ISVNDirEntry[] list(String path, SVNRevision revision,
			SVNRevision pegRevision, boolean recurse) throws SVNClientException {
		...
		try {
			...
			notificationHandler.logCommandLine(commandLine);
			notificationHandler.setBaseDir(new File("."));
			svnClient.list(path, JhlConverter.convert(revision),
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getDirEntry(
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getSingleStatus
	 * (java.io.File)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getStatus(java
	 * .io.File[])
	 */
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getStatus(java
	 * .io.File, boolean, boolean, boolean)
	 */
	public ISVNStatus[] getStatus(File path, boolean descend, boolean getAll,
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getStatus(java
	 * .io.File, boolean, boolean, boolean, boolean)
	 */
	public ISVNStatus[] getStatus(File path, boolean descend, boolean getAll,
			boolean contactServer, boolean ignoreExternals)
			throws SVNClientException {
		return getStatus(path, descend, getAll, contactServer, ignoreExternals,
				null);
	}
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getStatus(java
	 * .io.File, boolean, boolean, boolean, boolean, ISVNStatusCallback)
	 */
	public ISVNStatus[] getStatus(File path, boolean descend, boolean getAll,
			boolean contactServer, boolean ignoreExternals,
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getStatus(java
	 * .io.File, boolean, boolean, boolean, boolean, boolean,
	 * ISVNStatusCallback)
	 */
	public ISVNStatus[] getStatus(File path, boolean descend, boolean getAll,
			boolean contactServer, boolean ignoreExternals, boolean noIgnore,
		...
		Depth depth = Depth.unknownOrImmediates(descend); // If descend is true,
															// recurse fully,
															// else do only
															// immediate
															// children.
		notificationHandler.logCommandLine("status"
				+ (contactServer ? " -u" : "") + depthCommandLine(depth) + " "
				+ filePathSVN);
		...
		try {
			...
			if (statusCallback instanceof MyStatusCallback) {
				statusList = ((MyStatusCallback) statusCallback)
						.getStatusList();
			} else {
				statusList = ((JhlStatusCallback) statusCallback)
						.getStatusList();
			}
			svnClient.status(filePathSVN, depth, contactServer, // If update is
																// set, contact
																// the
																// repository
																// and augment
																...
																// about
																// out-of-dateness
					getAll, noIgnore, // retrieve all entries; otherwise,
										// retrieve only "interesting" entries
										// (local mods and/or out-of-date).
					ignoreExternals, null, statusCallback);

		
			try {
				return processFolderStatuses(
						processExternalStatuses(JhlConverter.convertStatus(
								statusList, svnClient)), getAll, contactServer);
...
*/					
		...
		return new JhlStatus[0];
	}

	/**
	 * A private status callback implementation used by thin wrappers. Instances
	...
	/**
	 * Post-process svn:externals statuses. JavaHL answer two sort of statuses
	 * on externals: - when ignoreExternals is set to true during call to
	 * status(), the returned status has textStatus set to EXTERNAL, but the url
	 * is null.<br>
	 * - when ignoreExternals is set to false during call to status(), besides
	 * the "external + null" status, the second status with url and all fields
	 * is returned too, but this one has textStatus NORMAL.
	 * 
	 * This methods unifies both statuses to be complete and has textStatus
	 * external. In case the first sort (when ignoreExternals true), the url is
	 * retrieved by call the info()
	 */
	protected JhlStatus[] processExternalStatuses(JhlStatus[] statuses)
			throws SVNClientException {
		...
		for (Integer integer : externalStatusesIndexes) {
			...
			for (int i = 0; i < statuses.length; i++) {
				if ((statuses[i].getPath() != null)
						&& (statuses[i].getPath().equals(jhlStatus.getPath()))) {
	...
	/**
	 * Post-process statuses. Folders do not return proper lastChangedRevision
	 * information. this allows it to be populated via the svn info command
	 */
	protected ISVNStatus[] processFolderStatuses(JhlStatus[] statuses,
			boolean getAll, boolean contactServer) throws SVNClientException {
		if (!getAll || !contactServer)
			return statuses;
		// Fill the missing last changed info on folders from the file info in
		// the array
		List<JhlStatus> folders = new ArrayList<JhlStatus>();
		for (int i = 0; i < statuses.length; i++) {
			JhlStatus jhlStatus = statuses[i];
			if (SVNNodeKind.DIR == jhlStatus.getNodeKind()
					&& jhlStatus.getReposLastChangedRevision() == null) {
			...
			if (jhlStatus.getLastChangedRevision() != null) {
				for (JhlStatus folder : folders) {
					if (jhlStatus.getUrlString() != null
							&& jhlStatus.getUrlString().startsWith(
									folder.getUrlString() + "/")) {
						if (folder.getLastChangedRevision() == null
								|| folder.getLastChangedRevision().getNumber() < jhlStatus
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#copy(java.io
	 * .File, java.io.File)
	 */
	public void copy(File srcPath, File destPath) throws SVNClientException {
		try {
			...
			copySources.add(new CopySource(src, Revision.WORKING,
					Revision.WORKING));
			svnClient.copy(copySources, dest, true, true, false, null, null,
					null);
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#copy(java.io
	 * .File, org.tigris.subversion.svnclientadapter.SVNUrl, java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#copy(org.tigris
	 * .subversion.svnclientadapter.SVNUrl, java.io.File,
	 * org.tigris.subversion.svnclientadapter.SVNRevision)
	 */
	 ...
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#copy(org.tigris
	 * .subversion.svnclientadapter.SVNUrl, java.io.File,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, boolean, boolean)
	 */
	public void copy(SVNUrl srcUrl, File destPath, SVNRevision revision,
			boolean copyAsChild, boolean makeParents) throws SVNClientException {
		copy(srcUrl, destPath, revision, SVNRevision.HEAD, copyAsChild,
				makeParents);
	}
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#copy(org.tigris
	 * .subversion.svnclientadapter.SVNUrl,
	...
	public void copy(SVNUrl srcUrl, SVNUrl destUrl, String message,
			...
			throws SVNClientException {
		copy(new SVNUrl[] { srcUrl }, destUrl, message, revision, true,
				makeParents);
	}
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#remove(org.tigris
	 * .subversion.svnclientadapter.SVNUrl[], java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#remove(java.
	 * io.File[], boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#doExport(org
	 * .tigris.subversion.svnclientadapter.SVNUrl, java.io.File,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#doExport(java
	 * .io.File, java.io.File, boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#doImport(java
	 * .io.File, org.tigris.subversion.svnclientadapter.SVNUrl,
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#mkdir(org.tigris
	 * .subversion.svnclientadapter.SVNUrl, java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#mkdir(java.io
	 * .File)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#move(java.io
	 * .File, java.io.File, boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#move(org.tigris
	 * .subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNUrl, java.lang.String,
	 * org.tigris.subversion.svnclientadapter.SVNRevision)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#update(java.
	 * io.File, org.tigris.subversion.svnclientadapter.SVNRevision, boolean)
	 */
	public long update(File path, SVNRevision revision, boolean recurse)
			throws SVNClientException {
		return update(path, revision, Depth.unknownOrFiles(recurse).ordinal(),
				false, false, true);
	}
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#update(java.
	 * io.File, org.tigris.subversion.svnclientadapter.SVNRevision, int,
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#revert(java.
	 * io.File, boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getContent(org
	 * .tigris.subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision,
	 * org.tigris.subversion.svnclientadapter.SVNRevision)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getContent(java
	 * .io.File, org.tigris.subversion.svnclientadapter.SVNRevision)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getProperties
	 * (java.io.File)
	 */
	...
	private ISVNProperty[] filterProperties(ISVNProperty[] properties,
			boolean includeEmptyProperties, boolean includeClosestOnly,
		...
		for (ISVNProperty property : properties) {
			if (filterProperties == null
					|| filterProperties.contains(property.getName())) {
				if (includeClosestOnly) {
	 ...
	 * .SVNRevision.Number,java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	public void propertySet(File path, String propertyName,
		...
		try {
			...
			if (propertyName.startsWith("svn:")) {
				// Normalize line endings in property value
				svnClient.propertySetLocal(paths, propertyName,
						fixSVNString(propertyValue).getBytes(),
						Depth.infinityOrEmpty(recurse), null, false);
			} else {
				svnClient.propertySetLocal(paths, propertyName,
						propertyValue.getBytes(),
						Depth.infinityOrEmpty(recurse), null, false);
			...
			// there is no notification (Notify.notify is not called) when we
			// set a property
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#propertySet(
	 * java.io.File, java.lang.String, java.io.File, boolean)
	 */
	public void propertySet(File path, String propertyName, File propertyFile,
		...
		try {
			...
			String target = fileToSVNPath(path, false);
			notificationHandler.logCommandLine("propset "
					+ (recurse ? "-R " : "") + propertyName + "-F \""
					+ propertyFile.toString() + "\" " + target);
			notificationHandler.setBaseDir(SVNBaseDir.getBaseDir(path));
			...
			svnClient.propertySetLocal(paths, propertyName, propertyBytes,
					Depth.infinityOrEmpty(recurse), null, false);
	 ...
	 * org.tigris.subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#propertyDel(
	...
	public void propertyDel(File path, String propertyName, boolean recurse)
		...
		try {
			...
			svnClient.propertySetLocal(paths, propertyName, null,
					Depth.infinityOrEmpty(recurse), null, true);
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#diff(java.io
	 * .File, org.tigris.subversion.svnclientadapter.SVNRevision, java.io.File,
	...
	public void diff(File oldPath, SVNRevision oldPathRevision, File newPath,
			...
			throws SVNClientException {
		diff(oldPath, oldPathRevision, newPath, newPathRevision, outFile,
				recurse, true, false, false);
	}

	private void diffRelative(File oldPath, SVNRevision oldPathRevision,
			File newPath, SVNRevision newPathRevision, File outFile,
			boolean recurse, boolean ignoreAncestry, boolean noDiffDeleted,
			boolean force, File relativeTo) throws SVNClientException {
		try {
			...
			notificationHandler.setBaseDir(SVNBaseDir.getBaseDir(new File[] {
					oldPath, newPath }));
			svnClient.diff(oldTarget, JhlConverter.convert(oldPathRevision),
					newTarget, JhlConverter.convert(newPathRevision),
					relativeToDir, svnOutFile, JhlConverter.depth(depth), null,
					ignoreAncestry, noDiffDeleted, force, true);
		} catch (ClientException e) {
			notificationHandler.logException(e);
			throw new SVNClientException(e);
		}
	...
	public void diff(File oldPath, SVNRevision oldPathRevision, File newPath,
		...
		try {
			...
			notificationHandler.setBaseDir(SVNBaseDir.getBaseDir(new File[] {
					oldPath, newPath }));
			svnClient.diff(oldTarget, JhlConverter.convert(oldPathRevision),
					newTarget, JhlConverter.convert(newPathRevision), null,
					svnOutFile, Depth.infinityOrEmpty(recurse), null,
					ignoreAncestry, noDiffDeleted, force, true);
		} catch (ClientException e) {
			notificationHandler.logException(e);
			throw new SVNClientException(e);
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#diff(org.tigris
	 * .subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision,
	 * org.tigris.subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, java.io.File,
	...
	public void diff(SVNUrl oldUrl, SVNRevision oldUrlRevision, SVNUrl newUrl,
			...
			throws SVNClientException {
		diff(oldUrl, oldUrlRevision, newUrl, newUrlRevision, outFile, recurse,
				true, false, false);
	}
	 ...
	 * org.tigris.subversion.svnclientadapter.SVNRevision,
	 * org.tigris.subversion.svnclientadapter.SVNRevision,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, java.io.File, int,
	 * boolean, boolean, boolean)
	 */
	...
	public void diff(SVNUrl target, SVNRevision pegRevision,
			SVNRevision startRevision, SVNRevision endRevision, File outFile,
			boolean recurse) throws SVNClientException {
		diff(target, pegRevision, startRevision, endRevision, outFile, Depth
				.infinityOrImmediates(recurse).ordinal(), true, false, false);
	}
	...
	public ISVNAnnotations annotate(File file, SVNRevision revisionStart,
		...
		return annotate(file, revisionStart, revisionEnd, null, ignoreMimeType,
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#annotate(org
	 * .tigris.subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision,
	 * org.tigris.subversion.svnclientadapter.SVNRevision)
	 */
	public ISVNAnnotations annotate(SVNUrl url, SVNRevision revisionStart,
		...
		return annotate(url.toString(), revisionStart, revisionEnd, null,
				false, false);
	}
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#annotate(java
	 * .io.File, org.tigris.subversion.svnclientadapter.SVNRevision,
	 * org.tigris.subversion.svnclientadapter.SVNRevision)
	 */
	public ISVNAnnotations annotate(File file, SVNRevision revisionStart,
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#resolved(java
	 * .io.File)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#cancelOperation
	 * ()
	 */
	 ...
	 * 
	 * @see org.tigris.subversion.svnclientadapter.ISVNClientAdapter#
	 * getInfoFromWorkingCopy(java.io.File)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getInfo(java
	 * .io.File)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getInfo(org.
	 * tigris.subversion.svnclientadapter.SVNUrl)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#switchUrl(org
	 * .tigris.subversion.svnclientadapter.SVNUrl, java.io.File,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, boolean)
	 */
	public void switchToUrl(File path, SVNUrl url, SVNRevision revision,
			boolean recurse) throws SVNClientException {
		switchToUrl(path, url, revision, Depth.unknownOrFiles(recurse)
				.ordinal(), false, false, true);
	}
	...
	public void switchToUrl(File path, SVNUrl url, SVNRevision revision,
			...
			throws SVNClientException {
		switchToUrl(path, url, revision, revision, depth, setDepth,
				ignoreExternals, force);
	}
	...
	public void switchToUrl(File path, SVNUrl url, SVNRevision revision,
		...
		switchToUrl(path, url, revision, pegRevision, depth, setDepth,
				ignoreExternals, force, false);
	}
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#setConfigDirectory
	 * (java.io.File)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#cleanup(java
	 * .io.File)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#upgrade(java
	 * .io.File)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#merge(org.tigris
	 * .subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision,
	 * org.tigris.subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, java.io.File,
	...
	public void merge(SVNUrl path1, SVNRevision revision1, SVNUrl path2,
		...
		merge(path1, revision1, path2, revision2, localPath, force, Depth
				.infinityOrFiles(recurse).ordinal(), dryRun, ignoreAncestry,
				false);
	}
	...
	public void merge(SVNUrl path1, SVNRevision revision1, SVNUrl path2,
			...
			throws SVNClientException {
		SVNUrlWithPegRevision svnUrlWithPegRevision = new SVNUrlWithPegRevision(
				path1);
		...
		if (pegRevision == null) {
			if (revision2 == null)
				...
				pegRevision = revision2;
		}
		merge(svnUrlWithPegRevision.getUrl(), revision1,
				new SVNUrlWithPegRevision(path2).getUrl(), revision2,
				pegRevision, localPath, force, depth, dryRun, ignoreAncestry,
				recordOnly);
	}
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#mergeReintegrate
	 * (org.tigris.subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, java.io.File,
	 * boolean, boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#addPasswordCallback
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#lock(org.tigris
	 * .subversion.svnclientadapter.SVNUrl[], java.lang.String, boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#unlock(org.tigris
	 * .subversion.svnclientadapter.SVNUrl[], boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#lock(java.lang
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#unlock(java.
	 * io.File[], boolean)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#setRevProperty
	 * (org.tigris.subversion.svnclientadapter.SVNUrl,
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getRevProperty
	 * (org.tigris.subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision.Number)
	 */
	public String getRevProperty(SVNUrl url, SVNRevision.Number revisionNo,
			String propName) throws SVNClientException {
		String propData = null;
		try {
			notificationHandler.setCommand(ISVNNotifyListener.Command.PROPGET);

			notificationHandler.logCommandLine("propget --revprop -r "
					+ revisionNo.toString() + " \"" + propName + "\"  "
					+ url.toString());
			notificationHandler.setBaseDir();
			byte[] bytes = svnClient.revProperty(url.toString(), propName,
					Revision.getInstance(revisionNo.getNumber())); // setRevProperty(url.toString(),
																	// propName,
																	// Revision.getInstance(revisionNo.getNumber()),
																	// fixSVNString(propertyData),
																	// true);
			try {
				// Assume property data is UTF8. Technically, only svn: props
				// are forced
				// to be UTF8.
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#getRevProperties
	 * (org.tigris.subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision.Number)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#isAdminDirectory
	 * (java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#relocate(java
	 ...
	 * @see
	 * org.tigris.subversion.svnclientadapter.ISVNClientAdapter#diff(java.io
	 * .File, org.tigris.subversion.svnclientadapter.SVNUrl,
	 * org.tigris.subversion.svnclientadapter.SVNRevision, java.io.File,
	 * boolean)
	 */
	...
	public ISVNMergeInfo getMergeInfo(File path, SVNRevision revision)
			throws SVNClientException {
		return this.getMergeInfo(fileToSVNPath(path, false),
				JhlConverter.convert(revision));
	}
	...
	public ISVNMergeInfo getMergeInfo(SVNUrl url, SVNRevision revision)
			throws SVNClientException {
		return this
				.getMergeInfo(url.toString(), JhlConverter.convert(revision));
	}

	private ISVNMergeInfo getMergeInfo(String path, Revision revision)
			throws SVNClientException {
		try {
	...
	private SVNDiffKind getDiffKind(String changedResource,
		...
		} else if (addedLines && !deletedLines && !contextLines)
			diffKind = SVNDiffKind.ADDED;
		else if ((!deletedLines && !addedLines) || deletedLines && !addedLines
				&& !contextLines) {
	...
	public String[] suggestMergeSources(File path) throws SVNClientException {
		String[] sources = null;
		try {
			Set<String> s = svnClient.suggestMergeSources(
					fileToSVNPath(path, false), Revision.HEAD);
	...
	public String[] suggestMergeSources(SVNUrl url, SVNRevision peg)
		...
		String[] sources = null;
		try {
			Set<String> s = svnClient.suggestMergeSources(url.toString(),
	...
	public void createPatch(File[] paths, File relativeToPath, File outFile,
		...
		try {
			...
			for (int i = 0; i < paths.length; i++) {
				...
				this.diffRelative(paths[i], SVNRevision.BASE, paths[i],
						SVNRevision.WORKING, tempFile, recurse, false, false,
						false, relativeToPath);
