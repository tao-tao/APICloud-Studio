...
public class CefApp extends CefAppHandlerAdapter {
		...
		try {
			Runnable r =  new Runnable() {
				...
				public void run() {
					...
					isInitialized_ = 
                         N_Initialize(library_path, appHandler_);
				}
			};
   ...
   */
	private final String getJcefLibPath() {
		String library_path = System.getProperty("cef.path") + System.getProperty("path.separator") + System.getProperty("java.library.path");
