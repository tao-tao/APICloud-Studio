...
public class NameTextModifyListener extends TextModifyListener {
	public NameTextModifyListener(ConfigEditor editor, Text text,
			Config config, ControlDecoration decoration) {
		super(editor, text, config, decoration);
	}
	@Override
	protected void setContent(String texValue) {
		super.config.setName(texValue);
	}
