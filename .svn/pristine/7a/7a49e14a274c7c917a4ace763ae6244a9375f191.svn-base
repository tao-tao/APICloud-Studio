...
import com.apicloud.loader.platforms.ios.semaphore.util.StringUtil;
 ...
 public class JPlistBuilder {
   ...
   static {
    ...
    public static void main(String[] args) throws Exception {
        ...
        buildPList(new FileInputStream("src/com/semaphore/data/BuildManifest-iphone-3.1.plist"));
