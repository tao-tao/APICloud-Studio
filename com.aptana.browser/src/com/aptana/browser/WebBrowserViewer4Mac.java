...
import com.aptana.swt.webkitbrowser.OpenWindowEvent4Mac;
import com.aptana.swt.webkitbrowser.WebKitBrowser4Mac;

/**
 * @author Max Stepanov
 */
public class WebBrowserViewer4Mac extends Composite {

	public static final int NAVIGATION_BAR = 1 << 0;
	private WebKitBrowser4Mac browser;
	 ...
	 * @param style
	 */
	public WebBrowserViewer4Mac(Composite parent, int style) {
		...
		browser = new WebKitBrowser4Mac(browserArea, SWT.NONE);
		...
		browser.addOpenWindowListener(new OpenWindowListener() {
			public void open(WindowEvent event) {
				...
				WebBrowserViewer4Mac browser2 = new WebBrowserViewer4Mac(shell2, style);
				shell2.layout();
				browser2.newWindow = true;
				if (event instanceof OpenWindowEvent4Mac) {
					((OpenWindowEvent4Mac) event).browser = browser2.browser;
				} else {
	...
	protected void createCommandBar(Composite parent) {
		...
		BrowserSizeCategory[] categories = BrowserPlugin.getDefault()
	...
	private void updateNavigationButtons() {
		...
		// consoleAction.setEnabled(browser.getCefBroser() != null);
